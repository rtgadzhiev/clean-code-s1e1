...
var createNewTaskElement=function(taskString){
    ...
    listItem.className="todo-tasks__item task";
    ...
    editButton.className="task__button button_edit button";

    deleteButton.className="task__button button_remove button";
    deleteButtonImg.className = "button_remove__image"
